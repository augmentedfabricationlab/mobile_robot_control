__title__ = 'mobile_fabrication_control'
__description__ = 'A short description of the project'
__url__ = 'https://github.com/augmentedfabricationlab/mobile_fabrication_control'
__version__ = '0.0.1'
__author__ = 'TUM Professorship Digital Fabrication'
